...
3. Aplique a migration `supabase/migrations/20260819150000_create_dashboard_tabs.sql` no Supabase conectado ao projeto.
...
Depois da publicação, teste: login autorizado, tentativa de login não autorizado, criação de aba em dois navegadores, atualização automática e alteração de categoria sem remover tags existentes do n8n.
